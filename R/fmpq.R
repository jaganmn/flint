...
setMethod("Ops",
          c(e1 = "fmpq", e2 = "fmpq"),
          function (e1, e2)
              .Call(R_flint_fmpq_ops2, .Generic, e1, e2, NULL))
...
setMatrixOpsMethod(
          ...
          function (x, y) {
              if (.Generic != "%*%" && (missing(y) || is.null(y)))
                  return(.Call(R_flint_fmpq_ops2, .Generic, x, x, NULL))
              g <- get(.Generic, mode = "function")
              switch(typeof(y),
                     "NULL" =, "raw" =, "logical" =, "integer" =
                         g(x, fmpq(y)),
...
setMatrixOpsMethod(
          c(x = "fmpq", y = "fmpq"),
          function (x, y)
              .Call(R_flint_fmpq_ops2, .Generic, x, y, NULL))
...
setMethod("solve",
          ...
          function (a, b, ...) {
              if (missing(b))
                  return(.Call(R_flint_fmpq_ops1, "solve", a, NULL))
              switch(typeof(b),
                     "NULL" =, "raw" =, "logical" =, "integer" =
                         solve(a, fmpq(b), ...),
                     "double" =
...
setMethod("solve",
          c(a = "fmpq", b = "fmpq"),
          function (a, b, ...)
              .Call(R_flint_fmpq_ops2, "solve", a, b, NULL))
